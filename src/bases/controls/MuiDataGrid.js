    ...
    MuiDataGrid: {
      styleOverrides: {
        row: {
          ...
          '&.Mui-deleted-data': {
            backgroundColor: '#f12727 !important',
            //   "&:hover": {
            //     backgroundColor: "#98958F"
            //   }
          },
          ...
          '&.Mui-mold-hold': {
            // backgroundColor: '#ffeac8 !important',
          },
          '&.Mui-mold-red': {
            // backgroundColor: '#d85959 !important',
          },
        },
      },
    },
...
const MuiDataGrid = (props) => {
  ...
  const CustomFooter = () => {
    return (
      <GridFooterContainer sx={{ display: 'block !important' }}>
        <Box sx={{ float: 'left', lineHeight: '30px', ml: 1 }}>
          {rowCount > 0 && intl.formatMessage({ id: 'general.TotalRow' }, { row: rowCount })}
          {footerCustom &&
