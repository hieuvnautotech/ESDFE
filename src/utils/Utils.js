...
const isNullUndefinedEmptyStr = (obj) => {
  ...
  // return Object.entries(obj).find(([, value]) => value === null || value === undefined || value === '');

  const hasNullUndefinedEmptyStr = Object.values(obj).some(
    (value) => value === null || value === undefined || value === ''
  );

  return hasNullUndefinedEmptyStr;
};
