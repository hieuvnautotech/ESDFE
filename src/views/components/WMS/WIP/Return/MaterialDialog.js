import { MuiButton, MuiDataGrid, MuiDialog, MuiSearchField, MuiSubmitButton } from '@controls';
...
const MaterialDialog = ({ isOpen, onClose, fetchDataDetail, WIPRMId }) => {
  const intl = useIntl();
  ...
  async function fetchData() {
    ...
    const res = await WIPReturnService.getMaterialWIPList(params);
  ...
  const onSubmit = async () => {
    const res = await WIPReturnService.createReturnMaterialDetail(WIPRMId, MaterialLotList);
