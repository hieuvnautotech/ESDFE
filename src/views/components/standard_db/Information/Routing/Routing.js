...
export default function Routing() {
  ...
  const columns = [
    ...
    {
      field: 'ProcessName',
      headerName: intl.formatMessage({ id: 'general.ProcessName' }),
      flex: 0.4,
    },
    {
      field: 'IsFinalProcess',
      headerName: intl.formatMessage({ id: 'general.IsFinalProcess' }),
      flex: 0.3,
    },
    {
      field: 'createdName',
    ...
    },
    {
      ...
      width: 140,
      valueFormatter: (params) => (params?.value ? moment(params?.value).format('YYYY-MM-DD HH:mm') : null),
    },
    {
      field: 'modifiedName',
  ...
  const handleDelete = async (material) => {
    if (
      ...
      try {
        let res = await RoutingService.deleteModel({
          RoutingId: material.RoutingId,
  ...
  async function fetchData() {
    ...
    const res = await RoutingService.getRoutingList(params);
