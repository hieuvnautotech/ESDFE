...
const Supplier = (props) => {
  ...
  const handleRowSelection = (arrIds) => {
    ...
    if (rowSelected && rowSelected.length > 0) {
      setSelectedRow({ ...rowSelected[0], Expiration: rowSelected[0].Expiration == true ? '1' : '0' });
    } else {
      setSelectedRow({ ...SupplierDto, Expiration: '' });
    }
  };
  ...
  const columns = [
    ...
    {
      field: 'Website',
      headerName: intl.formatMessage({ id: 'supplier.Website' }),
      /*flex: 0.7,*/ width: 250,
    },
    {
      field: 'SupplierType',
      headerName: intl.formatMessage({ id: 'supplier.SupplierType' }),
      width: 200,
    },
    {
      field: 'Description',
      headerName: intl.formatMessage({ id: 'supplier.Description' }),
      width: 250,
    },
    {
      field: 'Email',
      headerName: intl.formatMessage({ id: 'supplier.Email' }),
      width: 180,
    },
    {
      field: 'PhoneNumber',
      headerName: intl.formatMessage({ id: 'supplier.PhoneNumber' }),
      width: 120,
    },
    {
      field: 'Fax',
      headerName: intl.formatMessage({ id: 'supplier.Fax' }),
      width: 120,
    },
    {
      field: 'Tax',
      headerName: intl.formatMessage({ id: 'supplier.Tax' }),
      width: 120,
    },
    {
      field: 'Address',
      headerName: intl.formatMessage({ id: 'supplier.Address' }),
      width: 250,
    },
    {
      field: 'DateSignContract',
      headerName: intl.formatMessage({ id: 'supplier.DateSignContract' }),
      width: 150,
    ...
    {
      field: 'DebtDate',
      headerName: intl.formatMessage({ id: 'supplier.DebtDate' }),
      width: 150,
      valueFormatter: (params) => {
        if (params.value !== null) {
          return moment(params?.value).format('YYYY-MM-DD');
