...
import { MuiDialog, MuiSubmitButton, MuiResetButton, MuiButton, MuiAutocomplete } from '@controls';
...
const CreateLineDialog = (props) => {
  ...
  const schemaY = yup.object().shape({
    ...
    AreaCode: yup.string().required(intl.formatMessage({ id: 'general.field_required' })),
  });
          ...
          <Grid container rowSpacing={2.5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
            ...
            <Grid item xs={12}>
              <MuiAutocomplete
                ...
                required
                value={
                  values.AreaCode ? { commonDetailCode: values.AreaCode, commonDetailLanguge: values.Location } : null
                }
                ...
                onChange={(e, value) => {
                  setFieldValue('Location', value?.commonDetailLanguge || '');
