...
export default function Material() {
  ...
  const columns = [
    ...
    {
      field: 'Standard',
      headerName: intl.formatMessage({ id: 'material.Standard' }),
      width: 200,
      renderCell: (params) => {
        return (
          <Typography sx={{ fontSize: 14 }}>
            {params.row.MaterialUnit == 'EA'
              ? `${params.row.Length} (EA/Bundle)`
              : `${params.row.Width} (mm) x ${params.row.Length} (m)`}
          </Typography>
        );
      },
    },
    // {
    //   field: 'IQCRawMaterialName',
    //   headerName: intl.formatMessage({ id: 'material.IQCRawMaterialId' }),
    //   width: 200,
    // },
    {
      field: 'IQCMaterialName',
      headerName: intl.formatMessage({ id: 'material.IQCMaterialId' }),
      width: 200,
    },
    {
      field: 'SupplierCode',
    ...
    },
    {
      ...
      headerName: intl.formatMessage({ id: 'material.ExpirationMonth' }),
      width: 150,
    },
    {
      field: 'Description',
  ...
  return (
    <React.Fragment>
      ...
      <MuiDataGrid
        ...
        initialState={{ pinnedColumns: { left: ['id', 'MaterialCode', 'MaterialName'], right: ['action'] } }}
      />
