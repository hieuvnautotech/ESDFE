...
const CommonDetail = ({ rowmaster }) => {
  ...
  const columns = [
    ...
    { field: 'commonDetailCode', headerName: intl.formatMessage({ id: 'general.code' }), flex: 0.3 },
    { field: 'commonDetailName', headerName: intl.formatMessage({ id: 'general.name' }), flex: 0.3 },
    { field: 'commonDetailLanguge', headerName: intl.formatMessage({ id: 'general.language_key' }), flex: 0.3 },
    ...
    <React.Fragment>
      <Grid container>
        <MuiButton
          ...
          sx={{ mt: 1, mb: 1 }}
          disabled={rowmaster.commonMasterId ? false : true}
        />
      </Grid>
      {menuState?.data && (
        <MuiDataGrid
