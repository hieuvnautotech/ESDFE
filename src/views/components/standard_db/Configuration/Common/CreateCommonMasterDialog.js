...
const CreateCommonMasterDialog = (props) => {
  ...
  const schema = yup.object().shape({
    ...
    commonMasterCode: yup.string().required(intl.formatMessage({ id: 'general.field_required' })),
  });
            ...
            <Grid container spacing={2}>
              <Grid item xs={RoleArr.includes('ROOT') ? 9 : 12}>
                <TextField
                  ...
                  name="commonMasterCode"
                  value={values.commonMasterCode}
                  onChange={handleChange}
                  error={touched.commonMasterCode && Boolean(errors.commonMasterCode)}
                  helperText={touched.commonMasterCode && errors.commonMasterCode}
                />
              </Grid>
