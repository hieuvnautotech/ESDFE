...
import RoleSettingDialog from './RoleSettingDialog';
...
export default function Role() {
  ...
  const [isShowing4, toggle4] = useState(false);
          ...
          <Grid container spacing={1} alignItems="center" justifyContent="center">
            ...
            <Grid item xs={4} style={{ textAlign: 'center' }}>
              <IconButton
                ...
                onClick={() => settingRolehandle(params.row)}
                disabled={params.row.roleName == 'ROOT'}
              >
  ...
  return (
    <React.Fragment>
      ...
      <RoleSettingDialog isOpen={isShowing4} onClose={() => toggle4(false)} roleId={roleId} />
    </React.Fragment>
  );
}
