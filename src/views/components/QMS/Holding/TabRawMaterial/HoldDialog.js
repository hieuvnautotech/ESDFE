...
const HoldDialog = ({ isOpen, onClose, MaterialLot, resetList, unHold, DataSelect }) => {
  const intl = useIntl();
  ...
  const onSubmit = async (data) => {
    ...
    const res = unHold ? await HoldRawMaterialService.unHold(formData) : await HoldRawMaterialService.hold(formData);
