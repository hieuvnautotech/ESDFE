...
import IQCCheckDialog from '../../TabMaterial/IQCCheckDialog';

const HoldLogMaterial = (props) => {
  const intl = useIntl();
  ...
  async function fetchData() {
    ...
    const res = await HoldLogService.GetLogMaterial(params);
...
export default HoldLogMaterial;
