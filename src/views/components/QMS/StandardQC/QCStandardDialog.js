...
const QCStandardDialog = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    if (mode == CREATE_ACTION) {
      const res = await QCStandardService.create(data);
      ...
      const res = await QCStandardService.modify({
        ...data,
        QCStandardId: initModal.QCStandardId,
        ...
        <Grid container rowSpacing={2.5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={12}>
            <MuiAutocomplete
              ...
              fetchDataFunc={QCStandardService.getQCType}
          ...
          <Grid item xs={12}>
            <MuiAutocomplete
              ...
              fetchDataFunc={() => QCStandardService.getQCItem(values.QCTypeId)}
          ...
          <Grid item xs={12}>
            <MuiAutocomplete
              ...
              fetchDataFunc={QCStandardService.getQCApply}
...
export default QCStandardDialog;
