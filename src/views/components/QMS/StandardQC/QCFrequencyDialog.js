...
const QCFrequencyDialog = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    if (mode == CREATE_ACTION) {
      const res = await QCFrequencyService.create(data);
      ...
      const res = await QCFrequencyService.modify({
        ...data,
        QCFrequencyId: initModal.QCFrequencyId,
        ...
        <Grid container rowSpacing={2.5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          ...
          <Grid item xs={12}>
            <MuiAutocomplete
              ...
              fetchDataFunc={QCFrequencyService.getQCApply}
...
export default QCFrequencyDialog;
