...
const TabGeneral = (props) => {
  ...
  async function fetchDataChart() {
    ...
    const res = await QMSReportService.getChartIQCRawGeneral(params);
  ...
  async function fetchDataGrid() {
    ...
    const res = await QMSReportService.GetIQCRawGeneral(params);
  ...
  const handleDownload = async () => {
    try {
      ...
      await QMSReportService.downloadIQCRaw(params);
    } catch (error) {
