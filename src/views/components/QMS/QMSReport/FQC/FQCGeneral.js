...
const FQCGeneral = (props) => {
  ...
  async function fetchData() {
    ...
    const res = await QCFQCReportService.getFQCGeneral(params);
    const resC = await QCFQCReportService.getFQCGeneralChart(params);
  ...
  const handleDownload = async () => {
    try {
      ...
      await QCFQCReportService.downloadAPPGeneral(params);
    } catch (error) {
