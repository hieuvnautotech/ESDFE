...
const Login = (props) => {
  ...
  const setDefaultLanguage = () => {
    localStorage.setItem(ConfigConstants.LANG_CODE, language);
    if (language === 'VI') {
      return countries[1];
    } else if (language === 'EN') {
      return countries[0];
      ...
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        >
          <Box className="content-login">
            <Typography variant="h3">ESD</Typography>
          </Box>
        </Grid>
              ...
              <Box sx={{ mt: 1 }}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, newValue) => {
                    var code = newValue.code === 'VI' ? 'VI' : newValue.code === 'KR' ? 'KR' : 'EN';
                    changeLanguage(code);
                    localStorage.setItem(ConfigConstants.LANG_CODE, code);
                  }}
                  renderOption={(props, option) => (
                    <Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0 } }} {...props}>
                      {option.code === 'EN' ? (
                        ...
                        <i className="flag-icon flag-icon-kr mr-2"></i>
                      ) : (
