...
import SlitReceivingDetail from './SitReceivingDetail';
import SlitReceivingAllLotDialog from './SlitReceivingAllLotDialog';

export default function SlitReceivingWMS() {
  const intl = useIntl();
  ...
  return (
    <React.Fragment>
      ...
      <SlitReceivingDetail MSOId={MSOId} />

      <SlitReceivingAllLotDialog MSOModel={View} isOpen={isShowing} onClose={toggle} />
    </React.Fragment>
  );
}
