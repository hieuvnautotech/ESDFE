...
import SitReceivingLotDialog from './SlitReceivingLotDialog';

export default function SlitReceivingDetail({ MSOId }) {
  const intl = useIntl();
  ...
  return (
    <React.Fragment>
      ...
      <SitReceivingLotDialog isOpen={isShowing} onClose={toggle} MSODetailId={MSODetailId} fetchDataDetail={toggle2} />
    </React.Fragment>
  );
}
