...
const SlitReturnDialog = ({ initModal, isOpen, onClose, setNewData, setUpdateData, mode }) => {
  const intl = useIntl();
  ...
  const onSubmit = async (data) => {
    ...
    if (mode == CREATE_ACTION) {
      const res = await ReturnMaterialService.createReturnMaterial(data);
      ...
      const res = await ReturnMaterialService.modifyReturnMaterial(data);
...
export default SlitReturnDialog;
