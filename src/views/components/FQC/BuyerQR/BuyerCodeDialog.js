...
const BuyerCodeDialog = ({ isOpen, onClose, handleSetNewData }) => {
  const intl = useIntl();
    ...
    >
      <form onSubmit={handleSubmit}>
        <Grid container rowSpacing={2.5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          <Grid item xs={6}>
            <MuiAutocomplete
              value={values.ProductId ? { ProductId: values.ProductId, ProductLabel: values.ProductLabel } : null}
